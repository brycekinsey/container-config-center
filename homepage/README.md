- [Main Site](https://gethomepage.dev/en/installation/docker/)
- [Repo](https://github.com/benphelps/homepage)

*The remainder of this file was copied from the [README.md](https://github.com/benphelps/homepage/blob/main/README.md) file located in the original project repo on September 5, 2023. Changes may have been made since this date, so it is recommended to check the project repo and documentation using the provided links.*
